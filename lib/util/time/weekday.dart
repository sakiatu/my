...
class Weekday implements Comparable<Weekday> {
  ...
  const Weekday._(this.value, this.name, this.shortName, this.shortestName,
  ...
  static const Weekday saturday =
      Weekday._(6, 'Saturday', 'Sat', 'S', true, false);

  /// Represents Sunday (value: 7).
  static const Weekday sunday =
      Weekday._(7, 'Sunday', 'Sun', 'Su', true, false);
  ...
  Weekday get previous => values[(value - 1 + 7 - 1) %
      7]; // Need -1 twice for 0-based index and previous day
